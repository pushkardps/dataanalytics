...
---
## Objective
The purpose of this page is to perform exploratory data analysis on the Gapminder data. In this assignment, I have performed data transformation and manipulation tasks using basic functions of dplyr package.  
...
- How has the per capita income increased over the years for the country with max per capita income? </br>
- How populated are the countries with lowest per capita income? </br>
